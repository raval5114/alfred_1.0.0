...
// } catch (Exception e) {
// throw new IllegalStateException("Missing environment variables and failed to
// load .env file", e);
// }
// }

// if (key == null || url == null) {
// throw new IllegalStateException("GROQ_API_KEY or GROQ_API_URL not set in
// environment or .env");
// }
...
// HttpEntity<>(mapper.writeValueAsString(payload), headers);
